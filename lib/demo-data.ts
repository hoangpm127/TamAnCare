...
export const vouchers = [
  {
    ...
    usage: "0/500",
    minSpend: 200000,
    expiresAt: "7 ngày kể từ ngày nhận",
    constraint: "Một lần cho mỗi tài khoản mới · Bill từ 200K",
    accent: "#8f241d",
    active: true,
  },
  {
...
export const packagePlans = [
  {
    id: "pkg-5",
    name: "Body 60 phút · 5 buổi",
    description: "Liệu trình Body 60 phút · tương đương 390.000đ/buổi.",
    serviceId: "svc-body-60",
    paidSessions: 5,
    bonusSessions: 0,
    sessions: 5,
    ...
    validityDays: 60,
    sold: 16,
    badge: "Tiết kiệm 300K",
    highlight: false,
  },
  {
    id: "pkg-9",
    name: "Body 60 phút · 10 buổi",
    description: "Liệu trình Body 60 phút · tương đương 350.000đ/buổi.",
    serviceId: "svc-body-60",
    paidSessions: 10,
    bonusSessions: 0,
    sessions: 10,
    ...
    validityDays: 90,
    sold: 21,
    badge: "Tiết kiệm 1 triệu",
    highlight: true,
  },
  {
    id: "pkg-body-60-15",
    name: "Body 60 phút · 15 buổi",
    description: "Liệu trình Body 60 phút · tương đương 320.000đ/buổi.",
    serviceId: "svc-body-60",
    paidSessions: 15,
    bonusSessions: 0,
    sessions: 15,
    ...
    validityDays: 90,
    sold: 0,
    badge: "Tiết kiệm 1,95 triệu",
    highlight: false,
  },
  {
    id: "pkg-body-90-5",
    name: "Body 90 phút · 5 buổi",
    description: "Liệu trình Body 90 phút · tương đương 550.000đ/buổi.",
    serviceId: "svc-body-90",
    paidSessions: 5,
    bonusSessions: 0,
    sessions: 5,
    ...
    validityDays: 60,
    sold: 0,
    badge: "Tiết kiệm 500K",
    highlight: false,
  },
  {
    id: "pkg-body-90-10",
    name: "Body 90 phút · 10 buổi",
    description: "Liệu trình Body 90 phút · tương đương 500.000đ/buổi.",
    serviceId: "svc-body-90",
    paidSessions: 10,
    bonusSessions: 0,
    sessions: 10,
    ...
    validityDays: 90,
    sold: 0,
    badge: "Tiết kiệm 1,5 triệu",
    highlight: true,
  },
  {
    id: "pkg-body-90-15",
    name: "Body 90 phút · 15 buổi",
    description: "Liệu trình Body 90 phút · tương đương 450.000đ/buổi.",
    serviceId: "svc-body-90",
    paidSessions: 15,
    bonusSessions: 0,
    sessions: 15,
  ...
  {
    id: "pkg-body-120-5",
    name: "Body 120 phút · 5 buổi",
    description: "Liệu trình Body 120 phút · tương đương 690.000đ/buổi.",
    serviceId: "svc-body-120",
    paidSessions: 5,
    bonusSessions: 0,
    sessions: 5,
    price: 3450000,
  ...
  {
    id: "pkg-body-120-10",
    name: "Body 120 phút · 10 buổi",
    description: "Liệu trình Body 120 phút · tương đương 650.000đ/buổi.",
    serviceId: "svc-body-120",
    paidSessions: 10,
    bonusSessions: 0,
    sessions: 10,
    ...
    validityDays: 90,
    sold: 0,
    badge: "Tiết kiệm 1,4 triệu",
    highlight: true,
  },
  {
    id: "pkg-body-120-15",
    name: "Body 120 phút · 15 buổi",
    description: "Liệu trình Body 120 phút · tương đương 600.000đ/buổi.",
    serviceId: "svc-body-120",
    paidSessions: 15,
    bonusSessions: 0,
    sessions: 15,
