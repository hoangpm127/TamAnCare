  ...
  return (
    <article className="overflow-hidden rounded-2xl border border-[#e7d6ca] bg-[#fffdfb]">
      ...
      <div className="grid gap-2 p-3 sm:grid-cols-2">
        ...
        <div className="rounded-xl bg-[#fff8e8] p-2.5"><p className="text-[9px] font-bold uppercase tracking-wide text-[#76551d]">Tip KTV ngoài Bill</p><p className="mt-1 text-xs font-bold leading-4 text-[#76551d]">Khách trao trực tiếp nếu hài lòng</p><p className="mt-0.5 text-[8px] leading-3.5 text-[#8a7457]">Mức gợi ý riêng được hiển thị theo từng dịch vụ</p></div>
      </div>
