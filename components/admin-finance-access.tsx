...
export function AdminFinanceAccess() {
  ...
  return (
    <main className="min-h-[70vh] bg-[#160f0e] px-4 py-12 text-white">
      <div className="mx-auto max-w-lg rounded-3xl border border-[#e8c665]/20 bg-white/5 p-6 text-center">
        <span className="mx-auto flex h-12 w-12 items-center justify-center rounded-full bg-[#e8c665]/10 text-[#e8c665]"><LockKeyhole size={22} /></span>
        ...
        <Link href="/admin" className="mt-5 inline-flex items-center gap-2 rounded-full bg-[#e8c665] px-5 py-2.5 text-sm font-semibold text-[#2b1b13]"><ArrowLeft size={15} /> Về báo cáo đầu tư</Link>
      </div>
    </main>
  );
}
