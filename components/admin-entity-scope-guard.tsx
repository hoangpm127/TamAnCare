  ...
  if (session.role !== "OWNER" && session.branchId !== branchId) {
    return (
      <div className="mx-auto max-w-xl px-4 py-12 text-center">
        <span className="mx-auto flex h-14 w-14 items-center justify-center rounded-full bg-[#fff2ef] text-[#9f1d20]"><LockKeyhole size={23} /></span>
        ...
        <Link href="/admin/therapists" className="mt-5 inline-flex rounded-full bg-[#9f1d20] px-4 py-2.5 text-sm font-semibold text-white">Về danh sách KTV</Link>
      </div>
    );
  }
