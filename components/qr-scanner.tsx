  ...
  return (
    <div className="relative aspect-[4/3] w-full overflow-hidden rounded-2xl bg-black">
      ...
      <div className="pointer-events-none absolute left-1/2 top-1/2 aspect-square w-[64%] -translate-x-1/2 -translate-y-1/2">
        ...
        <span className="absolute left-[10%] right-[10%] top-1/2 h-0.5 -translate-y-1/2 bg-gradient-to-r from-transparent via-[#e7c878] to-transparent shadow-[0_0_10px_rgba(245,217,130,0.9)]" />
        <span className="absolute left-1/2 top-1/2 h-2.5 w-2.5 -translate-x-1/2 -translate-y-1/2 rounded-full border-2 border-white bg-[#c64b32] shadow-[0_0_0_5px_rgba(255,255,255,0.12)]" />
      </div>
      {status === "starting" ? (
