...
export function ActiveServiceBanner() {
  ...
  return (
    <div className="sticky top-14 z-30 border-b border-[#b8dfc9] bg-[#effaf3]/95 px-3 py-1.5 shadow-[0_4px_14px_rgba(22,120,74,0.10)] backdrop-blur">
      <Link href={href} className="mx-auto flex max-w-3xl items-center gap-2.5 rounded-xl bg-gradient-to-r from-[#126b42] to-[#1d8f55] px-3 py-2 text-white shadow-sm">
        <span className="relative flex h-8 w-8 shrink-0 items-center justify-center rounded-full bg-white/15">
          ...
          <i className="absolute -right-0.5 -top-0.5 h-2.5 w-2.5 rounded-full bg-[#f5d982] ring-2 ring-[#16784a]" />
        </span>
