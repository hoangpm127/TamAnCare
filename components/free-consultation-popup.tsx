...
export function FreeConsultationPopup() {
  ...
  return (
    <div className="fixed inset-0 z-[80] flex items-end justify-center bg-[#2c0909]/74 p-0 backdrop-blur-sm sm:items-center sm:p-5" role="presentation">
      ...
      >
        <div className="relative overflow-hidden bg-gradient-to-br from-[#4c191b] via-[#8b2b28] to-[#c64b32] px-5 pb-5 pt-6 text-white sm:px-6">
          <div className="absolute -right-10 -top-14 h-36 w-36 rounded-full border-[18px] border-[#d8b449]/15" />
          <div className="relative">
            <span className="inline-flex items-center gap-1.5 rounded-full border border-[#f2d477]/35 bg-white/10 px-3 py-1 text-[11px] font-bold uppercase tracking-[0.12em] text-[#e8cf8a]">
        ...
        <div className="space-y-4 p-5 sm:p-6">
            ...
            {TIME_OPTIONS.map((option) => {
              ...
              return (
                <button
                  ...
                  className={`rounded-2xl border px-2 py-3 text-center transition ${active ? "border-[#b4232b] bg-[#f8ebe5] text-[#7c2927] shadow-sm" : "border-[#e8ddc7] bg-white text-[#68574f]"}`}
                >
          ...
          <div className="rounded-2xl bg-[#f7f1df] p-3 text-[11px] leading-5 text-[#66563f] ring-1 ring-[#e7d6aa]">
            <p className="flex items-start gap-2"><ShieldCheck className="mt-0.5 shrink-0 text-[#a63d2e]" size={15} /><span>Bằng việc đăng ký, bạn đồng ý để đội ngũ liên hệ số điện thoại tài khoản nhằm xác nhận lịch. Buổi tư vấn giúp định hướng chăm sóc, không thay thế khám, chẩn đoán hoặc điều trị y khoa.</span></p>
          </div>
          ...
          <button
            ...
            className="flex w-full items-center justify-center gap-2 rounded-full bg-gradient-to-b from-[#c64b32] to-[#8b2b28] px-5 py-3.5 text-sm font-semibold text-white shadow-lg shadow-[#8b2b28]/20 disabled:opacity-60"
          >
