...
## Nhận diện khách hàng, Mã PIN và OTP dự phòng

- Cấu hình vận hành hiện tại ưu tiên khách trung tuổi: tạo hồ sơ bằng họ tên, số điện thoại và **Mã PIN Tâm An 4 số**; không yêu cầu OTP, mật khẩu dài, Google hoặc Facebook. Giữ `CUSTOMER_OAUTH_ENABLED=false`, `PHONE_VERIFICATION_REQUIRED=false`, `PHONE_VERIFICATION_ON_SIGNUP_REQUIRED=false` và `OTP_PROVIDER=DISABLED`.
...
- PIN phải gồm đúng 4 số và không chấp nhận chuỗi quá dễ đoán như `0000`, `1234` hoặc 4 số cuối điện thoại. PIN chỉ lưu dưới dạng băm; không ghi vào log, thông báo hay hồ sơ hiển thị.
- Đăng nhập sai bị giới hạn theo chính số điện thoại trên toàn hệ thống: tối đa 5 lần trong 30 phút, sau đó khóa 30 phút. Giới hạn IP bổ sung ngăn thử hàng loạt nhiều tài khoản.
- Phiên hồ sơ được cấp trong 365 ngày và tự gia hạn khi khách vẫn sử dụng webapp. Khách có thể chủ động đăng xuất bất cứ lúc nào.
- Nếu quên PIN, nhân viên chỉ cấp lại khi khách có mặt và đã được đối chiếu trực tiếp bằng số điện thoại, lịch sử phục vụ hoặc thông tin nghiệp vụ phù hợp. Cấp lại PIN sẽ thu hồi toàn bộ phiên cũ; không đọc PIN qua điện thoại hoặc tin nhắn.
