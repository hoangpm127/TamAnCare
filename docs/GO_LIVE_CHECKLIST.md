...
- Nếu `PHONE_VERIFICATION_REQUIRED=false`, xác nhận luồng hồ sơ họ tên + số điện thoại + Mã PIN Tâm An 4 số, chặn trùng số, khóa thử PIN, phiên 365 ngày tự gia hạn và quy trình lễ tân đối chiếu/cấp lại PIN/kiểm tra voucher–hoa hồng tại cơ sở. Giữ `CUSTOMER_OAUTH_ENABLED=false`; OTP SMS/Zalo là hạng mục nâng cấp sau và không bật mã test ở production.
