      ...
      <body className="m-0 bg-[#fffaf6] font-sans text-[#191414]">
        <main className="flex min-h-screen items-center justify-center px-5">
          <section className="w-full max-w-md rounded-3xl border border-[#eadbd1] bg-white p-6 text-center shadow-xl">
            <p className="text-xs font-semibold uppercase tracking-[0.16em] text-[#9f1d20]">Tâm An Care</p>
            ...
            <button type="button" onClick={reset} className="mt-5 w-full rounded-full bg-[#9f1d20] px-4 py-3 text-sm font-semibold text-white">
              Thử tải lại
            </button>
          </section>
        </main>
