  ...
  return (
    <main className="flex min-h-screen items-center justify-center bg-[#fffaf6] px-5 text-[#191414]">
      <section className="w-full max-w-md rounded-3xl border border-[#eadbd1] bg-white p-6 text-center shadow-xl">
        <p className="text-xs font-semibold uppercase tracking-[0.16em] text-[#9f1d20]">404 · Tâm An Care</p>
        ...
        <Link href="/" className="mt-5 inline-flex w-full items-center justify-center rounded-full bg-[#9f1d20] px-4 py-3 text-sm font-semibold text-white">
          Về trang chủ
        </Link>
      </section>
    </main>
