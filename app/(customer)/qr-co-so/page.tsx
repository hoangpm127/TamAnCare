  ...
  return (
    <main className="min-h-screen bg-[#f7f3ef] px-4 py-6 text-[#191414] sm:px-6">
      <section className="mx-auto max-w-3xl">
        ...
        <div className="mt-5 rounded-2xl bg-[#173d36] p-4 text-center text-white">
          ...
          <Link href="/check-in" className="mt-3 inline-flex rounded-full bg-white px-5 py-2.5 text-xs font-semibold text-[#173d36]">Mở camera check-in</Link>
        </div>
      </section>
    </main>
  );
