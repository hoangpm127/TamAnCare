    ...
    <main className="min-h-[calc(100vh-56px)] bg-[radial-gradient(circle_at_top,#ffe8d8_0%,#fffaf6_42%,#fffaf6_100%)] px-4 py-5 text-[#191414] sm:py-10">
      <div className="mx-auto w-full max-w-md space-y-3">
        <section className="overflow-hidden rounded-[1.75rem] border border-[#eadbd1] bg-white shadow-xl">
          <div className="relative overflow-hidden bg-gradient-to-br from-[#c22630] via-[#d13f1f] to-[#4d0c10] px-5 pb-6 pt-7 text-center text-white">
          ...
          <div className="space-y-4 p-5">
            <div className="rounded-2xl bg-[#fff7df] p-4 text-center ring-1 ring-[#e3b23c]/45">
              <Sparkles className="mx-auto text-[#d13f1f]" size={22} />
              <p className="mt-2 text-[10px] font-bold uppercase tracking-[0.14em] text-[#805914]">Quyền lợi dành cho bạn</p>
              {offer ? (
                <>
                  <p className="mt-1 text-2xl font-bold text-[#d13f1f]">Giảm {formatMoney(offer.discountValue)}</p>
                ...
                <p className="mt-1 text-sm font-semibold leading-6 text-[#d13f1f]">Mã giới thiệu đã được ghi nhận. Hệ thống sẽ tự áp dụng ưu đãi đang còn hiệu lực.</p>
              )}
            </div>
            ...
            <div className="space-y-2.5 text-xs leading-5 text-[#554842]">
              ...
              <p className="flex items-start gap-2"><ShieldCheck size={16} className="mt-0.5 shrink-0 text-[#d13f1f]" /><span>Bạn chỉ cần đăng nhập và xác minh OTP một lần khi muốn sử dụng ưu đãi.</span></p>
            </div>

            <div className="grid gap-2">
              <Link href="/booking" className="flex w-full items-center justify-center gap-2 rounded-full bg-[#d13f1f] px-5 py-3.5 text-sm font-semibold text-white shadow-md shadow-[#d13f1f]/20">
