    ...
    <main className="mx-auto max-w-3xl px-4 pb-6 pt-3 text-[#281b18] sm:px-6">
      ...
      <section className="overflow-hidden rounded-xl border border-[#e7d6ca] bg-gradient-to-br from-[#231514] to-[#3d1f12] text-white shadow-lg">
        <div className="p-5 sm:p-6">
          <p className="flex items-center justify-center gap-1.5 text-center text-xs font-semibold uppercase tracking-[0.14em] text-[#c59a3d]">
            <Sparkles size={14} /> Báo cáo thu nhập
          </p>
          <p className="mt-2 text-center text-3xl font-bold tracking-tight sm:text-4xl">{formatMoney(referral.totalEarned)}</p>
          <p className="mt-1 text-center text-xs text-white/70">Tổng thưởng đã nhận từ giới thiệu bạn bè</p>
      ...
      <section className="mt-5 rounded-xl border border-[#e7d6ca] bg-white p-4 shadow-sm">
        <div className="flex items-start justify-between gap-3">
          <div><h2 className="text-sm font-semibold">Hồ sơ nhận đối soát</h2><p className="mt-1 text-[11px] leading-4 text-[#826f66]">Dùng cho kỳ chuyển khoản 15 ngày; khách được giới thiệu không nhìn thấy thông tin me này.</p></div>
