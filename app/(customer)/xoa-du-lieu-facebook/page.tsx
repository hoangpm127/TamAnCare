...
export const metadata: Metadata = {
  title: "Hướng dẫn xóa dữ liệu Facebook · Tâm An Care",
  description: "Hướng dẫn yêu cầu ngắt liên kết Facebook và xóa dữ liệu tài khoản Tâm An Care.",
};
      ...
      <article className="mx-auto max-w-3xl overflow-hidden rounded-3xl bg-white shadow-xl ring-1 ring-[#eadbd1]">
        <header className="bg-gradient-to-br from-[#2d1815] via-[#63281c] to-[#9f1d20] px-5 py-7 text-white sm:px-8 sm:py-9">
          ...
          <p className="mt-5 flex items-center gap-2 text-xs font-bold uppercase tracking-[0.16em] text-[#f4d87e]">
            <ShieldCheck size={16} /> Tâm An Care
          </p>
          <h1 className="mt-2 text-2xl font-semibold tracking-tight sm:text-3xl">Yêu cầu xóa dữ liệu Facebook</h1>
          <p className="mt-3 max-w-2xl text-sm leading-6 text-white/75">
            Hướng dẫn ngắt liên kết Facebook và gửi yêu cầu xóa dữ liệu đã cung cấp cho Tâm An Care.
          </p>
        </header>
        ...
        <div className="space-y-7 px-5 py-6 text-sm leading-7 text-[#554842] sm:px-8 sm:py-8">
          <section>
            ...
            <ol className="mt-3 space-y-2 pl-5 marker:font-semibold marker:text-[#9f1d20]">
              ...
              <li className="list-decimal pl-1">Chọn Tâm An Care và gỡ ứng dụng để thu hồi quyền truy cập. Việc gỡ ứng dụng không tự động xóa lịch sử booking hoặc giao dịch cần lưu theo nghĩa vụ pháp lý.</li>
            </ol>
          </section>
          ...
          <section>
            ...
            <p className="mt-2">
              Sau khi đăng nhập, hãy liên hệ bộ phận hỗ trợ Tâm An Care qua kênh hỗ trợ hiển thị trên nền tảng và yêu cầu “Xóa dữ liệu Facebook”. Cung cấp số điện thoại của tài khoản để chúng tôi xác minh chủ thể yêu cầu; không gửi mật khẩu Facebook hoặc mã OTP.
            </p>
            <p className="mt-2">
