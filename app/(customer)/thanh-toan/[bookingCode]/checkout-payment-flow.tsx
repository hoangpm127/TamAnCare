  ...
  return (
    <main className="mx-auto max-w-2xl bg-[#fffaf6] px-4 py-6 text-[#191414]">
      <section className="overflow-hidden rounded-2xl border border-[#eadbd1] bg-white shadow-lg">
        ...
        <div className="grid grid-cols-3 divide-x divide-[#eadbd1] border-b border-dashed border-[#eadbd1] px-2 py-4 text-center"><span className="px-1 text-[10px] text-[#8a7a72]">Tổng Bill<strong className="mt-1 block text-sm text-[#191414]">{formatMoney(booking.totalAmount)}</strong></span><span className="px-1 text-[10px] text-[#8a7a72]">Đã đặt cọc<strong className="mt-1 block text-sm text-[#16784a]">{formatMoney(booking.paidAmount)}</strong></span><span className="px-1 text-[10px] text-[#8a7a72]">Còn lại<strong className="mt-1 block text-sm text-[#d13f1f]">{formatMoney(booking.dueAmount)}</strong></span></div>
