  ...
  return (
    <main className="flex min-h-[100dvh] items-center justify-center bg-[#fffaf6] px-5 text-[#191414]">
      <section className="w-full max-w-sm rounded-2xl border border-[#eadbd1] bg-white p-6 text-center shadow-sm">
        <WifiOff className="mx-auto text-[#9f1d20]" size={34} />
        ...
        <Link href="/" className="mt-5 inline-flex items-center justify-center gap-2 rounded-full bg-[#9f1d20] px-5 py-3 text-sm font-semibold text-white"><RefreshCw size={16} /> Thử tải lại</Link>
      </section>
    </main>
  );
}
