  ...
  return (
    <div className="mx-auto max-w-2xl px-4 py-6 sm:px-6">
      <section className="rounded-lg border border-[#e7d6ca] bg-white p-4 shadow-sm sm:p-5">
        <p className="text-sm font-semibold uppercase tracking-[0.18em] text-[#c64b32]">Chi tiết booking</p>
        <h1 className="mt-1 text-2xl font-semibold">{booking.customer.fullName}</h1>
        <div className="mt-5 space-y-3 text-sm text-[#68574f]">
        ...
        <Link href="/therapist" className="mt-5 inline-block text-sm font-semibold text-[#c64b32]">
          Quay lại lịch ca
        </Link>
      </section>
    </div>
