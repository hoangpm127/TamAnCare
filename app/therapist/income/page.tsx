...
export default async function TherapistIncomePage() {
  ...
  return <div className="mx-auto max-w-4xl px-3 py-4 sm:px-6">
    <header className="overflow-hidden rounded-3xl bg-gradient-to-br from-[#291714] via-[#63301f] to-[#9f1d20] p-5 text-center text-white shadow-xl">
